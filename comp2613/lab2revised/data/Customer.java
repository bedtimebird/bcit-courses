 ...
 * Time: 10:42:32 AM
 */
package lab2revised.data;

import lab2.data.util.Validator;
...
public class Customer {
	...
	public static class Builder {
		...
		public Builder firstName(String val) {
			firstName = Validator.validString(val);
			return this;
		}

		public Builder lastName(String val) {
			lastName = Validator.validString(val);
			return this;
		}

		public Builder streetName(String val) {
			streetName = Validator.validString(val);
			return this;
		}

		public Builder city(String val) {
			city = Validator.validString(val);
			return this;
		}

		public Builder postalCode(String val) {
			postalCode = Validator.postalCode(val);
			return this;
		}

		public Builder emailAddress(String val) {
			emailAddress = Validator.emailAddress(val);
			return this;
		}

		public Builder joinDate(String val) {
			joinDate = Validator.validString(val);
			return this;
		}
