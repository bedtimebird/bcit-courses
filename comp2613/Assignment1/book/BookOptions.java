...
public class BookOptions {
	 ...
	 * by_lastname Sorts the purchases report by part description in ascending order. This option is ignored if â€˜purchasesâ€™ isnâ€™t also specified
	 * by_title Sorts the purchases report by book title in ascending order. This option is ignored if â€˜purchasesâ€™ isnâ€™t also specified
	 * by_join_date Sorts the customer report by join date in ascending order. This option is ignored if â€˜customersâ€™ isnâ€™t also specified
	...
	public enum Value {
		...
		BY_AUTHOR("A", "by_author", false,
				"Sorts the books report by author in ascending order. This option is ignored if â€˜booksâ€™ isnâ€™t also specified"), //
		BY_LASTNAME("L", "by_lastname", false,
				"Sorts the purchases report by customer lastname in ascending order. This option is ignored if â€˜purchasesâ€™ isnâ€™t also specified"), //
		BY_TITLE("T", "by_title", false,
				"Sorts the purchases report by book title in ascending order. This option is ignored if â€˜purchasesâ€™ isnâ€™t also specified"), //
		BY_JOIN_DATE("J", "by_join_date", false,
				"Sorts the customers report by join date in ascending order. This option is ignored if â€˜customersâ€™ isnâ€™t also specified"), //
